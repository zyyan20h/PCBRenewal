...
class ComparisonOptionsDialog ( wx.Dialog ):
	...
	def __init__( self, parent ):
		wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = u"Compare Boards", pos = wx.DefaultPosition, size = wx.Size( 1029,862 ), style = wx.DEFAULT_DIALOG_STYLE|wx.RESIZE_BORDER )
